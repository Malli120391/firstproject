question_bank = [
    {"text": "The ability of one class to acquire methods and attributes from another class is called___.",
     "answer": "A"},
    ...
    {"text": "Whta is the depth of multilevel inheritance in Python?", "answer": "C"},
